...
public class AdminViewController {
    ...
    public ModelAndView registerBulkPass(ModelAndView modelAndView) {
        // bulk pass 목록을 조회합니다
        modelAndView.addObject("bulkPasses", bulkPassService);
        ...
        modelAndView.addObject("userGroupIds",);
    ...
    public String addBulkPass(ModelAndView("request") BulkPassRequest request, Model model) {
